...
from ZOYA_MUSIC.misc import HAPP, SUDOERS, XCB
from ZOYA_MUSIC.utils.database import (
    get_active_chats,
    remove_active_chat,
    remove_active_video_chat,
)
from ZOYA_MUSIC.utils.decorators.language import language
...
async def restart_(_, message):
    ...
    os.system(f"kill -9 {os.getpid()} && python3 -m ZOYA_MUSIC")
